#
#  Be sure to run `pod spec lint Medusa.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
"A NSOperation Network Framework."
                   DESC
  ...
  # Or just: s.author    = "David Alarcon"
  # s.authors            = { "David Alarcon" => "momachilles@gmail.com" }
 ...
 s.platform     = :ios, "11.0"
  ...
  s.source_files  = "Medusa/**/*.{h,m,swift}"
